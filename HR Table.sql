...
No_of_years_worked_at_current_comapany INT,
...
FROM 'C:\Users\bodap\OneDrive\Desktop\Jobaaj\projects\power BI\hr\archive (3)\HR_Attrition_dataset.csv'
	WITH (
		FIRSTROW = 2,
		FIELDTERMINATOR = ',' ,
		ROWTERMINATOR = '\n'
...
(
	...
	Work_life_balance,No_of_years_worked_at_current_comapany,No_of_years_in_current_role,Years_since_last_promotion
)
VALUES
-- Employee 10001
